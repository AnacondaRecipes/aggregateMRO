...
sources = {
           'win': {      'url': 'https://mran.blob.core.windows.net/install/mro/'+VERSION+'/microsoft-r-open-'+VERSION+'.exe',
                         ...
                         'sha': '7e1091587429c1545804b514269f4b0c588b85ec86052b512aafd491db797d93',  # 3.5.0
...
#                        'sha': '83c2f36f255483e49cefa91a143c020ad9dfdfd70a101432f1eae066825261cb',  # 3.4.1
           ...
           'mac': {      'url': 'https://mran.blob.core.windows.net/install/mro/'+VERSION+'/microsoft-r-open-'+VERSION+'.pkg',
                         ...
                         'sha': '105551bc5e6d4d6e1b24d328d27cae01c63fe0a357076bb2599c9be40e296f3a',  # 3.5.0
...
pushd unpack
  ...
  find . | LC_COLLATE=C sort --ignore-case > "$RECIPE_DIR"/filelists/filelist-mro-$PKG_VERSION-$target_platform.after-unpacking.txt
...
pushd unpack
  find . | LC_COLLATE=C sort --ignore-case > "$RECIPE_DIR"/filelists/filelist-mro-$PKG_VERSION-$target_platform.end-of-build-sh.txt
popd
'''
